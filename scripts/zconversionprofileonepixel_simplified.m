function conversionprofile = zconversionprofileonepixel_simplified(formulation,printer,numberofLayers,...
...
for i = nl:-1:1 % this loop goes through the layers
    ...
    for j = i:nl
        ...
        % [cp,dp,rEoi,layerStatuses,resinRefresh] = structureproperty...
...
for i = 1:j
    ...
    for x = i:j
    cp = conversionProfiles(ptInds(i,1):ptInds(i,2),x);
    nz = cp>0;
    if x==1; cla; end
    if x==j
